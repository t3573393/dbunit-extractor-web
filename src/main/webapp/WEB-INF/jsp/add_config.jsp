...
<html lang="en">
<head>
<title><spring:message code="add-db-config" /></title>
<content tag="head"> 
<!-- PNotify -->
	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h2><spring:message code="add-db-config" /></h2>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><spring:message code="database-connection-configs" /></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br>
                    <form id="dbConfig-form" name="DBConfigDTO" data-parsley-validate class="form-horizontal form-label-left" novalidate="" action="<c:url value="/add_config"/>">
                      <input type="hidden" value="add" name="operation" id="operation"/>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><spring:message code="config-name" /> <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="${DBConfigDTO.name}" name="name" id="name" required="required" class="form-control col-md-7 col-xs-12" data-parsley-id="5" />
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="dbType" class="form-control required" name="dbType" required="required">
